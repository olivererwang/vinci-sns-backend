/*
 * $Id: QunarMutiLongMonitor.java 3279 2011-12-08 10:30:22Z build $
 ...
 * @author sunli
 */
public class QunarMutiLongMonitor extends AbstractQunarMutiMonitor {

    private QunarMutiLongMonitor(String prefix, String description, boolean addPeriod) {
     ...
     * @return
     */
    public static QunarMutiLongMonitor buildWithPrefix(String prefix, String description) {
     ...
     * @return
     */
    public static QunarMutiLongMonitor buildWithPrefix(String prefix, String description, boolean addPeriod) {
        if (!instanceMap.containsKey(prefix)) {
            QunarMutiLongMonitor qunarMutiLongMonitor = new QunarMutiLongMonitor(prefix, description, addPeriod);
    ...
    protected MonitorCounter createMonitorCounter(String instanceName, String description) {
        return QunarMonitor.createAtomicLongCounter(instanceName, description);
    }
}
